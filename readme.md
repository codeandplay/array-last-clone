# array-last-clone [![NPM version](https://img.shields.io/npm/v/array-last.svg)](https://www.npmjs.com/package/array-last) [![Build Status](https://img.shields.io/travis/jonschlinkert/array-last.svg)](https://travis-ci.org/jonschlinkert/array-last)
### This is clone of https://github.com/jonschlinkert/array-last 
...
or, if [verb](http://github.com/verbose/verb) is installed globally:
```sh
$ verb
```
...
## License
Copyright &copyright 2016 [Jon Schlinkert](http://github.com/jonschlinkert)
Released under the [MIT license](https://github.com/jonschlinkert/array-last/blob/maaster/LICENSE).
